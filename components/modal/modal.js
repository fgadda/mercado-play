...
function ModalContent({ title, children }) {
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className="fixed left-[50%] top-[50%] max-h-[85vh] w-[950px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[3rem] data-[state=open]:animate-contentShow">
